            ...
            <div class="row">
              ...
              <div class="col-8">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="resposta_dissertativa" id="resposta_dissertativa" cols="30" rows="5" maxlength="4000"><?php echo $dados["resposta_dissertativa"] ?></textarea>
                </div>
              </div>
              <div class="col-2"></div>
            </div>
