  ...
  <body>
    ...
    <div class="container">
        ...
        <?php
            ...
            // monstrar curso que está sendo excluido
            //echo "<h2>Excluir Curso [$nome]</h2>";
        ?>

      <header>
        <div class="row">
          
          <h1 class="m-3">Excluir Curso</h1>
      ...
      <form name="formExcCurso" method="post" action="../validacoes/validaExcCurso.php">
        ...
        <div class="row float-right mr-5 mt-3">
          <button class="btn btn-outline-dark" id="btn" type="submit">Excluir Curso</button>
        </div>
      </form>
