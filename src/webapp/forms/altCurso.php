...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form name="formCurso" method="post" action="../validacoes/validaAltCurso.php">
        
        <div class="form-group">
            <input class="form-control" type="hidden" name="id" size="1" readonly  
            value="<?php echo $id; ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="number" id="duracao_meses" name="duracao_meses" min="4" required value="<?php echo $dados['duracao_meses'] ?>">
        </div>

        <button class="btn btn-outline-dark" type="submit">Alterar Curso</button>
      </form>
