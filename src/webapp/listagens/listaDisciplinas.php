  ...
  <body>
    ...
    <div class="container">
        ...
        <?php
            ...
            if($disciplinas == 0){
                die("<h3>NÃO HÁ NENHUMA DISCIPLINA CADASTRADA!</h3>");
            }
        ?>
        <!-- cabeçalho da tabela -->
        <section>
            ...
            <?php
                ...
                while($contador < $disciplinas)
                {
                    ...
                    echo "      <td>
                                    <a href='../forms/excDisciplina.php' class='btn btn-outline-dark'>
        ...
        <a href="../../../index.html">
            <button class="btn btn-outline-dark">Página Inicial</button>
        </a>
